...
class AudioProfile(BaseModel):
    ...
    search_queries: list[str] = Field(
        ...
        description="Spotify-optimized search queries generated by Gemini 2.5 Flash",
    )
...
class Track(BaseModel):
    ...
    external_url: str
    reason: Optional[str] = Field(None, description="AI's reason for recommending this track")
