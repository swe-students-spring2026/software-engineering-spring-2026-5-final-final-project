...
// ── Chat: register the "add to schedule" hook for this page ──────────────────
// chat.js (loaded before this file) calls window.onChatAddCourses(items) when
// the AI proposes a schedule. We supply the implementation here so the
// confirmation card's "Add to calendar" button works on the search page.
window.onChatAddCourses = addAiCoursesToSchedule;
