...
def build_task_document(user_id: str, title: str, description: str, due_date: str, priority: str) -> dict:
    return {
...
def insert_task(user_id: str, title: str, description: str, due_date: str, priority: str) -> str:
...
def find_task_by_id(task_id: str, user_id: str):
